    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto p-0">
        ...
        <div className="relative bg-gradient-to-br from-circle-primary to-circle-primary/80 text-white p-8">
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-lg text-white/90 mb-4">{service.description}</p>
              ...
              <div className="flex items-center gap-6 text-sm">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span>{service.estimated_roi}x ROI</span>
                </div>
                <div className="flex items-center gap-1">
        ...
        <div className="p-8">
          {/* Key Benefits */}
          <div className="mb-8">
            <h3 className="text-2xl font-bold mb-4">Why {service.title}?</h3>
                ...
                >
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="text-center mb-4">
                      ...
                      {pkg.savings && (
                        <Badge className="bg-destructive text-destructive-foreground text-xs mt-1 hover:bg-green-600 hover:text-white transition-colors">
                          {pkg.savings} OFF
                        </Badge>
                      )}
                    </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="bg-gradient-to-r from-circle-primary/5 to-circle-primary/10 border-circle-primary/20">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground mb-4">
                  Visit the official {service.vendor.name} website for detailed documentation and resources.
                </p>
                <Button 
                  variant="outline" 
                  className="w-full"
                  onClick={() => window.open(`https://${service.vendor.name.toLowerCase().replace(' ', '')}.com`, '_blank')}
                >
            ...
            <Card className="bg-gradient-to-r from-green-50 to-green-100 border-green-200">
              <CardContent className="p-6 text-center">
                <h4 className="text-xl font-bold mb-2">Questions? We're Here to Help!</h4>
                <p className="text-muted-foreground mb-4">
                  Speak with our experts to find the perfect package for your business.
                </p>
