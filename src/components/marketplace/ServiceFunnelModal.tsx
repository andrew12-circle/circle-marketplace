...
export const ServiceFunnelModal = ({
  ...
  return <Dialog open={isOpen} onOpenChange={open => !open && onClose()} modal={true}>
      <DialogContent className="max-w-[90vw] lg:max-w-6xl max-h-[90vh] overflow-hidden p-0 animate-scale-in">
        ...
        <div className="absolute top-4 right-20 z-50 flex gap-2 items-center">
                  ...
                  <div className="space-y-6 animate-fade-in">
                    ...
                    <div className="grid grid-cols-3 gap-1 sm:gap-4">
                        <div className="text-center p-1 sm:p-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 flex flex-col items-center justify-center">
                         ...
                         <div className="text-center p-1 sm:p-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 flex flex-col items-center justify-center">
                           <div className="text-sm sm:text-2xl font-bold">{(service.funnel_content?.duration && service.funnel_content.duration !== '30 days') ? service.funnel_content.duration : (service.duration && service.duration !== '30 days') ? service.duration : 'TBD'}</div>
                           <div className="text-[10px] sm:text-xs text-blue-200">Time to Results</div>
                         </div>
                        <div className="text-center p-1 sm:p-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 flex flex-col items-center justify-center">
                          <div className="text-sm sm:text-2xl font-bold">{isVerified && service.setup_time ? service.setup_time : 'TBD'}</div>
