    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()} modal={true}>
      <DialogContent className="max-w-[90vw] lg:max-w-6xl max-h-[90vh] overflow-hidden p-0 animate-scale-in">
        ...
        <div className="overflow-y-auto max-h-[90vh]">
          {/* Modern Hero Section */}
          <div className="relative bg-gradient-to-br from-slate-800 via-blue-800 to-purple-800 text-white overflow-hidden">
            ...
            {/* Subtle light overlay to reduce darkness without changing layout */}
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="space-y-6 animate-fade-in">
                    ...
                    {service.vendor && (
                      <div className="flex items-center gap-4 p-4 bg-white/20 backdrop-blur-sm rounded-xl border border-white/20">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div className="text-center p-3 bg-white/20 backdrop-blur-sm rounded-lg border border-white/20">
                  ...
                  <div className="relative animate-fade-in">
                    <div className="aspect-video bg-white/20 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/20 shadow-2xl">
                        ...
                        return thumbs.map((m, idx) => {
                          ...
                          return (
                            <button
                              ...
                              className="relative aspect-video bg-white/20 backdrop-blur-sm rounded-lg overflow-hidden border border-white/20 cursor-pointer hover-scale"
