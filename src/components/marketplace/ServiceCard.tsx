                        ...
                        <TooltipTrigger asChild>
                          <div className="flex items-center justify-between p-2 bg-circle-primary/5 rounded-lg border border-circle-primary/20 opacity-75 cursor-pointer">
                            <div className="flex items-center gap-1">
                              ...
                              <span className="text-sm font-medium text-circle-primary">Unlock Pro Price</span>
                               ...
                               return (
                                  <div className="space-y-1">
                                     ...
                                     <div className="text-xs bg-green-100 p-2 rounded border border-green-300 flex items-center justify-between">
                                       <span className="text-gray-600">With Vendor help your bill could be much less.</span>
