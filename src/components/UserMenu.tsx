...
export const UserMenu = () => {
  ...
  if (!user) {
    return (
      <Button asChild variant="outline" className="min-h-[44px] px-4 py-2 text-sm touch-target">
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <div className="relative">
          <Button variant="ghost" className="relative h-12 w-12 rounded-full touch-target min-h-[44px]">
            <Avatar className={`h-10 w-10 ${profile?.is_pro_member ? 'ring-2 ring-circle-accent ring-offset-2 ring-offset-background' : ''}`}>
              ...
              <AvatarFallback className="bg-circle-primary text-primary-foreground text-sm">
                {initials}
              </AvatarFallback>
            </Avatar>
          </Button>
