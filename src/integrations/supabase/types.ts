  ...
  public: {
    Tables: {
      ...
      lender_audit_log: {
        Row: {
          action: string | null
          actor: Database["public"]["Enums"]["lender_actor_type"] | null
      ...
      lender_commitment: {
        Row: {
          ...
          id: string
          recurrency: Database["public"]["Enums"]["lender_recurrency"] | null
          request_id: string
          share: number | null
          start_date: string | null
          status: Database["public"]["Enums"]["lender_commitment_status"] | null
        ...
        Insert: {
          ...
          start_date?: string | null
          status?:
            | Database["public"]["Enums"]["lender_commitment_status"]
            | null
          vendor_org_id: string
        }
        Update: {
        ...
        Relationships: [
          {
            foreignKeyName: "lender_commitment_request_id_fkey"
            columns: ["request_id"]
            isOneToOne: false
            referencedRelation: "lender_request"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "lender_commitment_vendor_org_id_fkey"
            columns: ["vendor_org_id"]
            isOneToOne: false
            referencedRelation: "lender_vendor_org"
            referencedColumns: ["id"]
          },
        ]
      }
      lender_match_candidate: {
        ...
        Relationships: [
          {
            foreignKeyName: "lender_match_candidate_request_id_fkey"
            columns: ["request_id"]
            isOneToOne: false
            referencedRelation: "lender_request"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "lender_match_candidate_vendor_org_id_fkey"
            columns: ["vendor_org_id"]
            isOneToOne: false
            referencedRelation: "lender_vendor_org"
            referencedColumns: ["id"]
      ...
      lender_match_routing: {
        ...
        Relationships: [
          {
            foreignKeyName: "lender_match_routing_lo_id_fkey"
            columns: ["lo_id"]
            isOneToOne: false
            referencedRelation: "lender_vendor_roster"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "lender_match_routing_request_id_fkey"
            columns: ["request_id"]
            isOneToOne: false
            referencedRelation: "lender_request"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "lender_match_routing_vendor_org_id_fkey"
            columns: ["vendor_org_id"]
            isOneToOne: false
            referencedRelation: "lender_vendor_org"
            referencedColumns: ["id"]
      ...
      lender_notif_event: {
        Row: {
          channel: Database["public"]["Enums"]["lender_channel_type"] | null
          created_at: string | null
          error: string | null
          id: string
          lo_id: string | null
          payload: Json | null
          request_id: string
          status: Database["public"]["Enums"]["lender_notif_status"] | null
        ...
        Relationships: [
          {
            foreignKeyName: "lender_notif_event_lo_id_fkey"
            columns: ["lo_id"]
            isOneToOne: false
            referencedRelation: "lender_vendor_roster"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "lender_notif_event_request_id_fkey"
            columns: ["request_id"]
            isOneToOne: false
            referencedRelation: "lender_request"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "lender_notif_event_vendor_org_id_fkey"
            columns: ["vendor_org_id"]
            isOneToOne: false
            referencedRelation: "lender_vendor_org"
            referencedColumns: ["id"]
      ...
      lender_request: {
        Row: {
          agent_id: string
          agent_latlon: unknown
          created_at: string | null
          expires_at: string | null
          id: string
          requested_vendor_share: number | null
          sku_id: string
          status: Database["public"]["Enums"]["lender_request_status"] | null
        }
        Insert: {
          agent_id: string
          agent_latlon?: unknown
      ...
      lender_request_snapshot: {
        ...
        Relationships: [
          {
            foreignKeyName: "lender_request_snapshot_request_id_fkey"
            columns: ["request_id"]
            isOneToOne: true
            referencedRelation: "lender_request"
            referencedColumns: ["id"]
      ...
      lender_vendor_decision: {
        Row: {
          ...
          decision: Database["public"]["Enums"]["lender_decision_type"] | null
        ...
        Relationships: [
          {
            foreignKeyName: "lender_vendor_decision_request_id_fkey"
            columns: ["request_id"]
            isOneToOne: false
            referencedRelation: "lender_request"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "lender_vendor_decision_vendor_org_id_fkey"
            columns: ["vendor_org_id"]
            isOneToOne: false
            referencedRelation: "lender_vendor_org"
            referencedColumns: ["id"]
      ...
      lender_vendor_org: {
        Row: {
          ...
          type: Database["public"]["Enums"]["lender_org_type"]
        }
        Insert: {
          created_at?: string | null
          id?: string
      ...
      lender_vendor_priorities: {
        Row: {
          distance_km: number | null
          id: string
          tie_breaker: Database["public"]["Enums"]["lender_tie_breaker"] | null
          vendor_org_id: string
        }
        Insert: {
          distance_km?: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "lender_vendor_priorities_vendor_org_id_fkey"
            columns: ["vendor_org_id"]
            isOneToOne: true
            referencedRelation: "lender_vendor_org"
            referencedColumns: ["id"]
      ...
      lender_vendor_roster: {
        ...
        Relationships: [
          {
            foreignKeyName: "lender_vendor_roster_vendor_org_id_fkey"
            columns: ["vendor_org_id"]
            isOneToOne: false
            referencedRelation: "lender_vendor_org"
            referencedColumns: ["id"]
      ...
      lender_vendor_rule: {
        Row: {
          ...
          geo_scope: Database["public"]["Enums"]["lender_geo_scope"] | null
          id: string
          max_monthly_budget: number | null
          max_per_agent_commit: number | null
          min_buyers_12mo: number | null
          min_units_12mo: number | null
          msas: string[] | null
        ...
        Relationships: [
          {
            foreignKeyName: "lender_vendor_rule_vendor_org_id_fkey"
            columns: ["vendor_org_id"]
            isOneToOne: true
            referencedRelation: "lender_vendor_org"
            referencedColumns: ["id"]
      ...
      lender_vendor_user: {
        Row: {
          ...
          id: string
          is_active: boolean | null
          role: Database["public"]["Enums"]["lender_user_role"]
          user_id: string
          vendor_org_id: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "lender_vendor_user_vendor_org_id_fkey"
            columns: ["vendor_org_id"]
            isOneToOne: false
            referencedRelation: "lender_vendor_org"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      admin_self_check: { Args: never; Returns: Json }
      admin_self_check_enhanced: { Args: never; Returns: Json }
      admin_set_pro_status:
        | {
            Args: { actor?: string; pro: boolean; target_user: string }
            Returns: undefined
          }
        | { Args: { pro: boolean; target_user: string }; Returns: undefined }
      ...
      auto_block_suspicious_ips: { Args: never; Returns: undefined }
      ...
      calculate_vendor_stats: { Args: { vendor_uuid: string }; Returns: Json }
      ...
      check_admin_operation_rate_limit: { Args: never; Returns: boolean }
      check_admin_operation_rate_limit_enhanced: {
        Args: never
        Returns: boolean
      }
      check_admin_operation_rate_limit_safe: { Args: never; Returns: boolean }
      check_admin_operation_rate_limit_strict: { Args: never; Returns: boolean }
      ...
      check_expiring_payment_schedules: { Args: never; Returns: undefined }
      check_security_operation_rate_limit: { Args: never; Returns: boolean }
      clean_ip_address: { Args: { input_ip: string }; Returns: unknown }
      cleanup_expired_cache: { Args: never; Returns: undefined }
      cleanup_expired_security_data: { Args: never; Returns: undefined }
      cleanup_expired_user_sessions: { Args: never; Returns: undefined }
      cleanup_marketplace_cache: { Args: never; Returns: undefined }
      cleanup_old_security_events: { Args: never; Returns: undefined }
      clear_failed_attempts: {
        Args: { p_attempt_type?: string; p_identifier: string }
        Returns: undefined
      }
      create_data_checksum: { Args: { data_input: Json }; Returns: string }
      ...
      expire_co_pay_requests: { Args: never; Returns: undefined }
      expire_sponsored_positions: { Args: never; Returns: undefined }
      ...
      get_agent_points_summary: { Args: { p_agent_id: string }; Returns: Json }
      ...
      get_concierge_context: { Args: { p_agent_id: string }; Returns: Json }
      ...
      get_funnel_metrics: { Args: { p_period?: string }; Returns: Json }
      get_marketplace_cache: { Args: { p_cache_key: string }; Returns: Json }
      ...
      get_user_vendor_org_id: { Args: never; Returns: string }
      ...
      get_web_analytics: { Args: { p_period?: string }; Returns: Json }
      get_web_analytics_enhanced: { Args: { p_period?: string }; Returns: Json }
      ...
      is_vendor_admin_or_approver: { Args: never; Returns: boolean }
      link_funnel_events: { Args: { p_anon_id: string }; Returns: Json }
      ...
      process_background_job: { Args: { job_id: string }; Returns: Json }
      ...
      refresh_vendor_analytics_cache: { Args: never; Returns: undefined }
      save_service_draft: {
      ...
      start_admin_session: { Args: never; Returns: boolean }
      submit_service_draft: { Args: { p_service_id: string }; Returns: Json }
      submit_vendor_draft: { Args: { p_vendor_id: string }; Returns: Json }
      svc_save_core_patch: {
      ...
      trigger_trending_import: { Args: never; Returns: undefined }
      unlockrows: { Args: { "": string }; Returns: number }
      update_all_vendor_stats: { Args: never; Returns: undefined }
      update_creator_analytics: { Args: never; Returns: undefined }
      update_creator_analytics_weighted: { Args: never; Returns: undefined }
      update_playbook_creator_analytics: { Args: never; Returns: undefined }
      update_qbo_tokens: {
        Args: {
      ...
      user_has_specialty: { Args: { specialty_name: string }; Returns: boolean }
      validate_admin_session: {
        Args: { session_token: string }
        Returns: boolean
      }
      validate_admin_session_context: { Args: never; Returns: Json }
      ...
      validate_session_context: { Args: never; Returns: boolean }
      validate_uuid_field: { Args: { input_text: string }; Returns: boolean }
      ...
      verify_critical_data_integrity: { Args: never; Returns: boolean }
      warm_marketplace_cache: { Args: never; Returns: Json }
    }
    Enums: {
      ...
      lender_actor_type: "agent" | "vendor" | "system"
      lender_channel_type: "email" | "sms" | "push" | "webhook" | "voice"
      lender_commitment_status: "pending" | "active" | "canceled" | "completed"
      lender_decision_type:
        | "pending"
        | "approved"
        | "counter"
        | "declined"
        | "auto_expired"
      lender_geo_scope: "national" | "state" | "msa" | "zip"
      lender_notif_status: "pending" | "sent" | "failed" | "ack"
      lender_org_type: "lender" | "title" | "insurance" | "other"
      lender_recurrency: "one_time" | "monthly"
      lender_request_status:
        | "draft"
        | "searching"
        | "awaiting_vendor"
        | "countered"
        ...
        | "canceled"
        | "fulfilled"
      lender_tie_breaker: "distance" | "reviews" | "alpha"
      lender_user_role:
        | "admin"
        | "approver"
        | "analyst"
