...
-- Add sample translations for demonstration (optional - you can remove this part)
-- This is just to show how the system would work with actual translated content
...
LIMIT 10; -- Only update first 10 services as examples