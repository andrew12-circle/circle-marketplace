-- Step 2: Add critical indexes for RLS policy performance (only for existing columns)
...
CREATE INDEX IF NOT EXISTS idx_admin_notifications_vendor_id ON public.admin_notifications(vendor_id);
