...
-- Add missing RESPA fields to service_providers table
ALTER TABLE public.service_providers 
ADD COLUMN IF NOT EXISTS is_respa_regulated boolean,
...
BEGIN
  ...
  IF service_record.respa_category = 'settlement' THEN
    -- Settlement services: RESPA vendors can only cover marketing portion (typically 25%)
  ...
  ELSIF service_record.respa_category = 'adjacent' THEN
    -- RESPA-adjacent: More flexible but still limited (typically 50%)
